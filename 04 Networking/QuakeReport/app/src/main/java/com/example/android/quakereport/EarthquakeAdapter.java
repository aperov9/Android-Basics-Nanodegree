...
public class EarthquakeAdapter extends ArrayAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        magnitudeView.setText(""+currentEarthquake.getmMag());
        ...
        if(currentEarthquake.getmLocation().contains(" of ")){
            String[] parts = currentEarthquake.getmLocation().split("of");
                locationView.setText(parts[0] + "of");
                locationView2.setText(parts[1].substring(1));
        }else {
            locationView2.setText(currentEarthquake.getmLocation());
        }
