        ...
        try {
            ...
            if (featureArray.length() > 0) {
                ...
                for (int i = 0;i<featureArray.length();i++){
                    currentProperties = featureArray.getJSONObject(i).getJSONObject("properties");

                    double mag = currentProperties.getDouble("mag");
                    String location = currentProperties.getString("place").toString();
                    long time =Long.parseLong(currentProperties.getString("time"));
