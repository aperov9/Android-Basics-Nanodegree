...
public class RandomFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        final ArrayList<LocationInfo> food = new ArrayList<LocationInfo>(){{
            add(new LocationInfo(getString(R.string.random_name1),getString(R.string.random_description1),getString(R.string.location),4,R.drawable.moritzbastei));
            add(new LocationInfo(getString(R.string.random_name2),getString(R.string.random_description2),getString(R.string.location),4,R.drawable.lasertag));
        }};

        listView.setAdapter(new EventsAdapter(inflater,food,true));
        return rootView;
    }
}
